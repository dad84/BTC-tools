## This is a theoretical test that I will attempt to implement. The goal is to have peers share the work so that the same addresses are not scanned repeatedly.
